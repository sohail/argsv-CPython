...
#define		ARGSVVERSIONDOC	   "Version 0.1 - Written by, Sohail Qayum Malik"
...
/* TODO, make it work as such that it also works with GCC as well */
...
static void add_define(PyObject*, const char*, long);
